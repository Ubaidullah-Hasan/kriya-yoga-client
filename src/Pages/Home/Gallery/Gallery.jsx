...
const Gallery = () => {
    ...
    return (
        <div className="bg-[#F1E8D1] py-10 md:py-24">
            ...
            <div className="md:flex gap-5 justify-between mt-12 w-[90%] mx-auto ">
                ...
                <div className="grid grid-cols-1 gap-5">
                    {/* gfygyuui */}
                    <div className="mt-4 md:mt-0 md:w-[250px] bg-white border-[10px] border-white shadow"
                        data-aos="fade-down"
                    ...
                    <div className="md:w-[250px] bg-white border-[10px] border-white shadow"
                        data-aos="fade-down"
                        data-aos-easing="linear"
